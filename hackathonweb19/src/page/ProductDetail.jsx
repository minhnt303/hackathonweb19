            ...
            <div className='Profile' style={{ backgroundColor: '#fafafa', height: '635px' }}>
                ...
                <div className="profileMain">
                    <div className="profileArea">
                        ...
                        <Row style={{ borderBottom: '1px solid rgba(0, 0, 0, .0975)', paddingBottom: '20px' }} className="mobile">
                            <Col style={{ textAlign: 'center' }} xs='4'>
                                <img src={this.state.files}
                                    alt="weima-userProfileImage"
                                    className='userProfileImage' />
                        ...
                        <div className="profilerow2" style={{ color: 'hsl(0, 0%, 15%)',borderBottom: '1px solid rgba(0, 0, 0, .0975)', }}>
                                    <Row>
                                        <Col xs='4'>
                                            <span>
                                                <span style={{ fontWeight: '600' }}>{this.state.post}
                        ...
                        <Row>
                            {this.state.product.map((item, index) => (// eslint-disable-next-line
                                <a onClick={() => this.clickimage(item)} key={index} style={{ width: '33.33%', height: '33.33%' }}>
